...
- Passwords use salted scrypt (N=131072, r=8, p=1). Passwords must contain 12-256 characters. Sessions use opaque random cookies, HttpOnly, Secure in production, SameSite=Lax, and expire after 30 days. Store only session/reset token hashes.
