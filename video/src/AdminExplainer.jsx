...
const scenes = [
  ...
  {image:'03-member-dashboard.png',duration:180,step:'2',title:'Registration creates a member',detail:'The new member is not counted as an entry yet. They choose Add an entry or mark themselves as not participating.',x:105,y:582,caption:'bottom',label:'Add an entry'},
  {image:'04-member-account.png',duration:180,step:'2',title:'The member joins the round',detail:'The first entry is now counted and starts unpaid. Members can add or remove unpaid entries from Dashboard.',x:300,y:610,caption:'bottom',label:'Add another entry'},
  ...
  {image:'06-members-before-role.png',duration:180,step:'4',title:'Assign an admin role',detail:'Open Members & roles, find the person and change their Role menu from member to admin.',x:750,y:404,caption:'bottom'},
  {image:'07-members-admin-role.png',duration:150,step:'4',title:'The role changes immediately',detail:'Admins can manage payments, members, picks and results. Only the owner can assign roles or import a spreadsheet.',x:750,y:404,caption:'bottom',label:'admin'},
  {image:'08-entries-unpaid.png',duration:180,step:'5',title:'Approve each numbered entry',detail:'Open Entries & payments and click Mark paid beside the exact entry that has paid.',x:445,y:712,caption:'top',label:'Mark paid'},
