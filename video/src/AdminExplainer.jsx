...
const scenes = [
  ...
  {image:'03-member-dashboard.png',duration:180,step:'2',title:'Registration creates a member',detail:'The new member is not counted as an entry yet. They choose Add an entry or mark themselves as not participating.',x:110,y:288,caption:'bottom',label:'Add an entry'},
  {image:'04-member-account.png',duration:180,step:'2',title:'The member joins the round',detail:'The first entry is now counted and starts unpaid. Members can add or remove unpaid entries from Dashboard.',x:360,y:320,caption:'bottom',label:'Add another entry'},
  ...
  {image:'06-members-before-role.png',duration:180,step:'4',title:'Assign an admin role',detail:'Open Members & roles, find the person and change their Role menu from member to admin.',x:785,y:452,caption:'bottom'},
  {image:'07-members-admin-role.png',duration:150,step:'4',title:'The role changes immediately',detail:'Admins can manage payments, members, picks and results. Only the owner can assign roles or import a spreadsheet.',x:785,y:452,caption:'bottom',label:'admin'},
  {image:'08-entries-unpaid.png',duration:180,step:'5',title:'Approve each numbered entry',detail:'Open Entries & payments and click Mark paid beside the exact entry that has paid.',x:886,y:707,caption:'top',label:'Mark paid'},
  {image:'09-entries-paid.png',duration:210,step:'5',title:'Paid entries become active',detail:'The Paid, status and prize-pot figures update together. Owner and admin entries must also be marked paid.',x:820,y:709,caption:'top',label:'Paid'},
  {image:'10-manage-picks.png',duration:180,step:'6',title:'Choose the member and week',detail:'Open Manage picks, select the week, then click Choose team on the correct numbered entry.',x:640,y:596,caption:'top',label:'Choose team'},
  ...
  {image:'15-announcement.png',duration:180,step:'8',title:'Post a member announcement',detail:'In Settings, write the message, choose its type and tick Show to members. Use this for payments, deadlines or updates.',x:263,y:352,caption:'bottom',label:'Show to members'},
