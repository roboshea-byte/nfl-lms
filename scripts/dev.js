...
http.createServer(async(req,res)=>{
  ...
  if(['/login','/signup','/dashboard','/account','/admin','/reset-password','/help','/privacy','/weekly-picks'].includes(url.pathname)||url.pathname==='/'||url.pathname==='/index.html'||/^\/play\/[^/]+\/?$/.test(url.pathname)){
