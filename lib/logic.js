function createLMSLogic(SCHEDULE){
  ...
  function aliveAtWeek(S, comp, w){
    ...
    return new Set(S.entries.map(e=>e.id));
  }
  ...
  return {WEEKS, GAMES, gamesByWeek, teamGame, teamResult, weekSettled, weekHasResults, currentRound, roundEndWeek, defaultWeek, isPickLost, computeRound, usedTeams, aliveAtWeek, isAliveForWeek, kickoff, weekFirstKickoff, paymentWeek, isPaid, prizePot};
}
